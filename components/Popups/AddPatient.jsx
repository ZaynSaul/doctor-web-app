            ...
            <form onSubmit={handleSubmit(submitHandler)}>
              ...
              <div className="flex items-center justify-between p-6 space-x-2 rounded-b border-t border-gray-500  mt-4 w-full">
                ...
                <button
                  onClick={() => setIsModalOpen(false)}
                  type="button"
                  className="text-white bg-red-500 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 focus:z-10 "
                >
                  Cancel
                </button>
              </div>
